...
Source Database       : weixingame

Target Server Type    : MYSQL
Target Server Version : 50553
File Encoding         : 65001

Date: 2019-03-04 02:23:19
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for game_moneylog
-- ----------------------------
DROP TABLE IF EXISTS `game_moneylog`;
CREATE TABLE `game_moneylog` (
  `id` int(8) NOT NULL,
...
-- ----------------------------
-- Records of game_moneylog
-- ----------------------------
INSERT INTO `game_moneylog` VALUES ('0', '1', '1', '0000001', '19.00', '1');
INSERT INTO `game_moneylog` VALUES ('1', '1', '1', '0222222', '19.00', '1');
...
CREATE TABLE `game_user` (
  ...
  `yaoqing` tinyint(4) DEFAULT NULL,
  `yue` double(2,0) DEFAULT NULL,
  `yongjin` double(2,0) DEFAULT NULL,
  `createat` varchar(20) DEFAULT NULL,
  `loginat` varchar(20) DEFAULT NULL,
  `tuiguangjifen` double(10,0) DEFAULT NULL,
  `jiangli` varchar(20) DEFAULT NULL COMMENT '排行榜里边的东西',
  `yaoqingren` int(8) DEFAULT NULL COMMENT '邀请我的人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
INSERT INTO `game_user` VALUES ('0', 'adfkskfkds', '火星', '1', '1', '1', '16', '30', null, null, '80', '继续努力', '0');
INSERT INTO `game_user` VALUES ('1', 'fsahtgrshjgjg6zg2fdasg', '太阳', '1', '1', '1', '10', '10', null, null, '10', '继续努力', '0');
INSERT INTO `game_user` VALUES ('2', 'dsjkfdlkdslk', '月亮', '1', '1', '1', '20', '20', null, null, '15', '继续努力', '1');
INSERT INTO `game_user` VALUES ('3', 'asjfkdksaklgfd', '星星', '1', '1', '1', '30', '20', null, null, '4', '继续努力', '1');
...
-- ----------------------------
INSERT INTO `system_log` VALUES ('1', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-03-02 09:59:22');
INSERT INTO `system_log` VALUES ('2', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-03-03 21:44:26');
...
-- ----------------------------
INSERT INTO `system_user` VALUES ('10000', 'admin', '21232f297a57a5a743894a0e4a801fc3', '22222222', '', '', '', '22975', '2019-03-03 21:44:26', '1', '2,4', '0', null, '2015-11-13 15:14:22');
